...
The StreamTrack is analogous to an interpolated CoordinateFrame where the data is is a univariate function of the track arc-length. The call method returns a |Frame| by evaluating the interpolations.
...
.. automodapi:: trackstream.track.tests
   :include-all-objects:
