...
class Test_BoundDescriptor:
    """Test :class:`~trackstream.utils.descriptors.BoundDescriptor`."""
    ...
    def test_get_enclosing(self, descriptor, enclosing):
        """Test :meth:`~trackstream.utils.descriptors.BoundDescriptor._get_enclosing`."""
    ...
    def test_enclosing(self, descriptor, enclosing):
        """Test :attr:`~trackstream.utils.descriptors.BoundDescriptor._enclosing`."""
        assert descriptor._get_enclosing() is enclosing
    ...
    def test_set_name(self, descriptor_cls, enclosing_attr):
        """Test :attr:`~trackstream.utils.descriptors.BoundDescriptor.__set_name__`."""
        descriptor = descriptor_cls()
    ...
    def test_get(self, enclosing_cls, enclosing, enclosing_attr, thedescriptor, descriptor):
        """Test :attr:`~trackstream.utils.descriptors.BoundDescriptor.__get__`."""
